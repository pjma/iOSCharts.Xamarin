...
namespace iOSCharts
{
	...
	[Protocol, Model]
	interface BarLineScatterCandleBubbleChartDataProvider : IChartDataProvider
	{
	...
	[Protocol, Model]
	interface IBarLineScatterCandleBubbleChartDataSet : IIChartDataSet
	{
	...
	[Protocol, Model]
	interface IBarChartDataSet : IIBarLineScatterCandleBubbleChartDataSet
	{
	...
	[BaseType (typeof(NSObject))]
	interface ChartBaseDataSet : IIChartDataSet, INSCopying
	{
	...
	interface ChartDataSet
	{
		...
		// -(ChartDataEntry * _Nullable)entryForIndex:(NSInteger)i __attribute__((deprecated("Use `subscript(index:)` instead."))) __attribute__((warn_unused_result));
		[Export ("entryForIndex:")]
		[return: NullAllowed]
		ChartDataEntry EntryForIndex (nint i);
		...
		// -(NSInteger)entryIndexWithEntry:(ChartDataEntry * _Nonnull)e __attribute__((deprecated("Use `firstIndex(of:)` or `lastIndex(of:)`"))) __attribute__((warn_unused_result));
		[Export ("entryIndexWithEntry:")]
		nint EntryIndexWithEntry (ChartDataEntry e);

		// -(BOOL)addEntry:(ChartDataEntry * _Nonnull)e __attribute__((deprecated("Use `append(_:)` instead"))) __attribute__((warn_unused_result));
		[Export ("addEntry:")]
		bool AddEntry (ChartDataEntry e);
		...
		// -(BOOL)removeFirst __attribute__((deprecated("Use `func removeFirst() -> ChartDataEntry` instead."))) __attribute__((warn_unused_result));
		[Export ("removeFirst")]
		[Verify (MethodToProperty)]
		bool RemoveFirst { get; }

		// -(BOOL)removeLast __attribute__((deprecated("Use `func removeLast() -> ChartDataEntry` instead."))) __attribute__((warn_unused_result));
		[Export ("removeLast")]
		[Verify (MethodToProperty)]
		bool RemoveLast { get; }
	...
	interface BarLineScatterCandleBubbleChartDataSet : IIBarLineScatterCandleBubbleChartDataSet
	{
	...
	interface BarChartDataSet : IIBarChartDataSet
	{
		// -(instancetype _Nonnull)initWithEntries:(NSArray<ChartDataEntry *> * _Nullable)entries label:(NSString * _Nullable)label __attribute__((objc_designated_initializer));
		[Export ("initWithEntries:label:")]
		[DesignatedInitializer]
	...
	interface ChartViewBase : IChartAnimatorDelegate, IChartDataProvider
	{
	...
	interface BarLineChartViewBase : IBarLineScatterCandleBubbleChartDataProvider, IUIGestureRecognizerDelegate
	{
	...
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]
	interface ChartHighlighter : IIChartHighlighter
	{
	...
	[Protocol, Model]
	interface IBubbleChartDataSet : IIBarLineScatterCandleBubbleChartDataSet
	{
	...
	[BaseType (typeof(BarLineScatterCandleBubbleChartDataSet))]
	interface BubbleChartDataSet : IIBubbleChartDataSet
	{
	...
	interface BubbleChartRenderer
	{
		...
		unsafe void DrawDataSetWithContext (CGContextRef* context, IBubbleChartDataSet dataSet, nint dataSetIndex);
	...
	[Protocol, Model]
	interface ILineScatterCandleRadarChartDataSet : IIBarLineScatterCandleBubbleChartDataSet
	{
	...
	[Protocol, Model]
	interface ICandleChartDataSet : IILineScatterCandleRadarChartDataSet
	{
	...
	[BaseType (typeof(BarLineScatterCandleBubbleChartDataSet))]
	interface LineScatterCandleRadarChartDataSet : IILineScatterCandleRadarChartDataSet
	{
	...
	interface CandleChartDataSet : IICandleChartDataSet
	{
		// -(instancetype _Nonnull)initWithEntries:(NSArray<ChartDataEntry *> * _Nullable)entries label:(NSString * _Nullable)label __attribute__((objc_designated_initializer));
		[Export ("initWithEntries:label:")]
		[DesignatedInitializer]
	...
	interface IShapeRenderer
	{
		...
		unsafe void DataSet (CGContextRef* context, IScatterChartDataSet dataSet, ChartViewPortHandler viewPortHandler, CGPoint point, UIColor color);
	}

	// @interface ChevronDownShapeRenderer : NSObject <IShapeRenderer>
	[BaseType (typeof(NSObject))]
	interface ChevronDownShapeRenderer : IIShapeRenderer
	{
		...
		[Export ("renderShapeWithContext:dataSet:viewPortHandler:point:color:")]
		unsafe void RenderShapeWithContext (CGContextRef* context, IScatterChartDataSet dataSet, ChartViewPortHandler viewPortHandler, CGPoint point, UIColor color);
	}

	// @interface ChevronUpShapeRenderer : NSObject <IShapeRenderer>
	[BaseType (typeof(NSObject))]
	interface ChevronUpShapeRenderer : IIShapeRenderer
	{
		// -(void)renderShapeWithContext:(CGContextRef _Nonnull)context dataSet:(id<IScatterChartDataSet> _Nonnull)dataSet viewPortHandler:(ChartViewPortHandler * _Nonnull)viewPortHandler point:(CGPoint)point color:(UIColor * _Nonnull)color;
		[Export ("renderShapeWithContext:dataSet:viewPortHandler:point:color:")]
		unsafe void RenderShapeWithContext (CGContextRef* context, IScatterChartDataSet dataSet, ChartViewPortHandler viewPortHandler, CGPoint point, UIColor color);
	...
	[BaseType (typeof(NSObject))]
	interface CircleShapeRenderer : IIShapeRenderer
	{
		// -(void)renderShapeWithContext:(CGContextRef _Nonnull)context dataSet:(id<IScatterChartDataSet> _Nonnull)dataSet viewPortHandler:(ChartViewPortHandler * _Nonnull)viewPortHandler point:(CGPoint)point color:(UIColor * _Nonnull)color;
		[Export ("renderShapeWithContext:dataSet:viewPortHandler:point:color:")]
		unsafe void RenderShapeWithContext (CGContextRef* context, IScatterChartDataSet dataSet, ChartViewPortHandler viewPortHandler, CGPoint point, UIColor color);
	...
	[Protocol, Model]
	interface CombinedChartDataProvider : IBarChartDataProvider, IBubbleChartDataProvider, ICandleChartDataProvider, ILineChartDataProvider, IScatterChartDataProvider
	{
	...
	[BaseType (typeof(NSObject))]
	interface CrossShapeRenderer : IIShapeRenderer
	{
		// -(void)renderShapeWithContext:(CGContextRef _Nonnull)context dataSet:(id<IScatterChartDataSet> _Nonnull)dataSet viewPortHandler:(ChartViewPortHandler * _Nonnull)viewPortHandler point:(CGPoint)point color:(UIColor * _Nonnull)color;
		[Export ("renderShapeWithContext:dataSet:viewPortHandler:point:color:")]
		unsafe void RenderShapeWithContext (CGContextRef* context, IScatterChartDataSet dataSet, ChartViewPortHandler viewPortHandler, CGPoint point, UIColor color);
	...
	[BaseType (typeof(NSObject))]
	interface ChartDefaultAxisValueFormatter : IIChartAxisValueFormatter
	{
	...
	[BaseType (typeof(NSObject))]
	interface ChartDefaultFillFormatter : IIChartFillFormatter
	{
	...
	[BaseType (typeof(NSObject))]
	interface ChartDefaultValueFormatter : IIChartValueFormatter
	{
	...
	[Protocol, Model]
	interface ILineRadarChartDataSet : IILineScatterCandleRadarChartDataSet
	{
	...
	[Protocol, Model]
	interface ILineChartDataSet : IILineRadarChartDataSet
	{
	...
	[Protocol, Model]
	interface IPieChartDataSet : IIChartDataSet
	{
	...
	[Protocol, Model]
	interface IRadarChartDataSet : IILineRadarChartDataSet
	{
	...
	[Protocol, Model]
	interface IScatterChartDataSet : IILineScatterCandleRadarChartDataSet
	{
	...
	[BaseType (typeof(NSObject))]
	interface ChartIndexAxisValueFormatter : IIChartAxisValueFormatter
	{
	...
	interface ChartLegendRenderer
	{
		...
		unsafe void DrawFormWithContext (CGContextRef* context, nfloat x, nfloat y, ChartLegendEntry entry, ChartLegend legend);
	...
	[BaseType (typeof(LineScatterCandleRadarChartDataSet))]
	interface LineRadarChartDataSet : IILineRadarChartDataSet
	{
	...
	interface LineChartDataSet : IILineChartDataSet
	{
		// -(instancetype _Nonnull)initWithEntries:(NSArray<ChartDataEntry *> * _Nullable)entries label:(NSString * _Nullable)label __attribute__((objc_designated_initializer));
		[Export ("initWithEntries:label:")]
		[DesignatedInitializer]
	...
	interface LineChartRenderer
	{
		...
		unsafe void DrawCubicBezierWithContext (CGContextRef* context, ILineChartDataSet dataSet);
		...
		unsafe void DrawHorizontalBezierWithContext (CGContextRef* context, ILineChartDataSet dataSet);
	...
	[BaseType (typeof(NSObject))]
	interface ChartMarkerImage : IIChartMarker
	{
	...
	[BaseType (typeof(NSUIView))]
	interface ChartMarkerView : IIChartMarker
	{
		// @property (nonatomic) CGPoint offset;
		[Export ("offset", ArgumentSemantic.Assign)]
		CGPoint Offset { get; set; }
	...
	// @interface Charts_Swift_3732 (NSUIView)
	[Category]
	[BaseType (typeof(NSUIView))]
	interface NSUIView_Charts_Swift_3732
	{
	...
	// @interface Charts_Swift_3744 (NSUIView)
	[Category]
	[BaseType (typeof(NSUIView))]
	interface NSUIView_Charts_Swift_3744
	{
		// -(NSArray * _Nullable)accessibilityChildren __attribute__((warn_unused_result));
		[NullAllowed, Export ("accessibilityChildren")]
		[Verify (MethodToProperty), Verify (StronglyTypedNSArray)]
	...
	[BaseType (typeof(ChartDataSet))]
	interface PieChartDataSet : IIPieChartDataSet
	{
		// -(instancetype _Nonnull)initWithEntries:(NSArray<ChartDataEntry *> * _Nullable)entries label:(NSString * _Nullable)label __attribute__((objc_designated_initializer));
		[Export ("initWithEntries:label:")]
		[DesignatedInitializer]
	...
	[BaseType (typeof(LineRadarChartDataSet))]
	interface RadarChartDataSet : IIRadarChartDataSet
	{
		// -(instancetype _Nonnull)initWithEntries:(NSArray<ChartDataEntry *> * _Nullable)entries label:(NSString * _Nullable)label __attribute__((objc_designated_initializer));
		[Export ("initWithEntries:label:")]
		[DesignatedInitializer]
	...
	[BaseType (typeof(LineScatterCandleRadarChartDataSet))]
	interface ScatterChartDataSet : IIScatterChartDataSet
	{
	...
	[BaseType (typeof(NSObject))]
	interface SquareShapeRenderer : IIShapeRenderer
	{
		// -(void)renderShapeWithContext:(CGContextRef _Nonnull)context dataSet:(id<IScatterChartDataSet> _Nonnull)dataSet viewPortHandler:(ChartViewPortHandler * _Nonnull)viewPortHandler point:(CGPoint)point color:(UIColor * _Nonnull)color;
		[Export ("renderShapeWithContext:dataSet:viewPortHandler:point:color:")]
		unsafe void RenderShapeWithContext (CGContextRef* context, IScatterChartDataSet dataSet, ChartViewPortHandler viewPortHandler, CGPoint point, UIColor color);
	...
	[BaseType (typeof(NSObject))]
	interface TriangleShapeRenderer : IIShapeRenderer
	{
		// -(void)renderShapeWithContext:(CGContextRef _Nonnull)context dataSet:(id<IScatterChartDataSet> _Nonnull)dataSet viewPortHandler:(ChartViewPortHandler * _Nonnull)viewPortHandler point:(CGPoint)point color:(UIColor * _Nonnull)color;
		[Export ("renderShapeWithContext:dataSet:viewPortHandler:point:color:")]
		unsafe void RenderShapeWithContext (CGContextRef* context, IScatterChartDataSet dataSet, ChartViewPortHandler viewPortHandler, CGPoint point, UIColor color);
	...
	// @interface Charts_Swift_4326 (UIPanGestureRecognizer)
	[Category]
	[BaseType (typeof(UIPanGestureRecognizer))]
	interface UIPanGestureRecognizer_Charts_Swift_4326
	{
	...
	// @interface Charts_Swift_4332 (UIPinchGestureRecognizer)
	[Category]
	[BaseType (typeof(UIPinchGestureRecognizer))]
	interface UIPinchGestureRecognizer_Charts_Swift_4332
	{
	...
	// @interface Charts_Swift_4338 (UIRotationGestureRecognizer)
	[Category]
	[BaseType (typeof(UIRotationGestureRecognizer))]
	interface UIRotationGestureRecognizer_Charts_Swift_4338
	{
	...
	// @interface Charts_Swift_4343 (UIScreen)
	[Category]
	[BaseType (typeof(UIScreen))]
	interface UIScreen_Charts_Swift_4343
	{
	...
	// @interface Charts_Swift_4348 (UIScrollView)
	[Category]
	[BaseType (typeof(UIScrollView))]
	interface UIScrollView_Charts_Swift_4348
	{
	...
	// @interface Charts_Swift_4353 (UITapGestureRecognizer)
	[Category]
	[BaseType (typeof(UITapGestureRecognizer))]
	interface UITapGestureRecognizer_Charts_Swift_4353
	{
		// -(NSInteger)nsuiNumberOfTouches __attribute__((warn_unused_result));
		[Export ("nsuiNumberOfTouches")]
		[Verify (MethodToProperty)]
	...
	// @interface Charts_Swift_4359 (UIView)
	[Category]
	[BaseType (typeof(UIView))]
	interface UIView_Charts_Swift_4359
	{
	...
	interface ChartXAxisRenderer
	{
		...
		unsafe void DrawLabelWithContext (CGContextRef* context, string formattedLabel, nfloat x, nfloat y, NSDictionary<NSString, NSObject> attributes, CGSize constrainedToSize, CGPoint anchor, nfloat angleRadians);
		...
		unsafe void DrawGridLineWithContext (CGContextRef* context, nfloat x, nfloat y);
	...
	interface XAxisRendererHorizontalBarChart
	{
		...
		unsafe void DrawLabelWithContext (CGContextRef* context, string formattedLabel, nfloat x, nfloat y, NSDictionary<NSString, NSObject> attributes, CGPoint anchor, nfloat angleRadians);
	...
	[BaseType (typeof(NSObject))]
	interface XShapeRenderer : IIShapeRenderer
	{
		// -(void)renderShapeWithContext:(CGContextRef _Nonnull)context dataSet:(id<IScatterChartDataSet> _Nonnull)dataSet viewPortHandler:(ChartViewPortHandler * _Nonnull)viewPortHandler point:(CGPoint)point color:(UIColor * _Nonnull)color;
		[Export ("renderShapeWithContext:dataSet:viewPortHandler:point:color:")]
		unsafe void RenderShapeWithContext (CGContextRef* context, IScatterChartDataSet dataSet, ChartViewPortHandler viewPortHandler, CGPoint point, UIColor color);
	...
	interface ChartYAxisRenderer
	{
		...
		unsafe void DrawGridLineWithContext (CGContextRef* context, CGPoint position);
		...
		unsafe void DrawZeroLineWithContext (CGContextRef* context);
	...
	interface YAxisRendererHorizontalBarChart
	{
		...
		unsafe void DrawYLabelsWithContext (CGContextRef* context, nfloat fixedPosition, NSValue[] positions, nfloat offset);
